...
public class GetQuoteLocators {
	...
	public String Getquotetextlocator_AvailableinHambergerMenu(){
		...
		String GetQuoteText_Locator=".//*[@id='nav']/li[1]/ul/li[3]/a/span";
		return GetQuoteText_Locator;
	}
	
	public String GetquoteHeadertextLocator(){
		
		String GetQuoteheadertextLocator = ".//*[@id='quoteForm']/div[1]/div/div[1]";
		return GetQuoteheadertextLocator;
	}
	
	public String Defaulttext_AboveShipmentLocator(){
		
		String Defaulttext_AboveShipmentLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[1]";
		return Defaulttext_AboveShipmentLocator;
	}
	
	public String DefaultMessage_justAboveShipmentLocator(){
		
		String DefaultMessage = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/span";
		return DefaultMessage;
	}
	
	public String FirstShipmentHeadingLocator(){
		
		String FirstShipmentName = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[3]/div/h4";
		return FirstShipmentName;
	}
	
	public String SecondShipmentHeadingLocator(){
		
		String SecondShipmentName = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[4]/div/h4";
		return SecondShipmentName;
	}
	
	public String ThirdShipmentHeadingLocator(){
		
		String ThirdShipmentName = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[5]/div/h4";
		return ThirdShipmentName;
	}
	
	public String FourthShipmentHeadingLocator(){
		
		String FourthShipmentName = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[6]/div/h4";
		return FourthShipmentName;
	}
	
public String FifthShipmentHeadingLocator(){
		
		String FifthShipmentName = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[7]/div/h4";
...
public String FirstShipmentdefaultMessageLocator(){
	...
	String FirstShipmentdefaultMsgLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[3]/div/p";
	return FirstShipmentdefaultMsgLocator;
}

public String SecondShipmentdefaultMessageLocator(){
	
	String SecondShipmentdefaultMsgLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[4]/div/p";
	return SecondShipmentdefaultMsgLocator;
}

public String ThirdShipmentdefaultMessageLocator(){
	
	String ThirdShipmentdefaultMsgLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[5]/div/p";
	return ThirdShipmentdefaultMsgLocator;
	}

public String FourthShipmentdefaultMessageLocator(){
	
	String FourthShipmentdefaultMsgLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[6]/div/p";
	return FourthShipmentdefaultMsgLocator;
}

public String FifthShipmentdefaultMessageLocator(){
	
	String FifthShipmentdefaultMsgLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[7]/div/p";
	return FifthShipmentdefaultMsgLocator;
}

 public String DocumentShipmentLocator(){
	
	String DocumentShipment = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[3]/div";
	return DocumentShipment;
}

public String LaptopsShipmentLocator(){
	
	String SachelsandLaptopsShipment = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[4]/div/p";
	return SachelsandLaptopsShipment;
}

public String SmallBoxShipmentLocator(){
	
	String SmallBoxShipment = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[5]/div/p";
	return SmallBoxShipment;
}

public String CakesandFlowersShipmentLocator(){
	
	String CakesandFlowersShipment = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[6]/div/p";
	return CakesandFlowersShipment;
}

public String LargeBoxShipmentLocator(){
	
	String LargeBoxShipment = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[7]/div/p";
...
public String GeneralVanSubshipment_LargeItemLocator(){
	...
	String GeneralVanSubShipment_LargeItem = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[1]/div";
	return GeneralVanSubShipment_LargeItem;
}

public String Furniture_LargeItemLocator(){
	
	String FurnitureSubShipment_LargeItem = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[2]/div";
	return FurnitureSubShipment_LargeItem;
}

public String BuildingMaterials_LargeItemLocator(){
	
	String BuildingMaterialsSubshipment_LargeItem = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[3]/div";
	return BuildingMaterialsSubshipment_LargeItem;
}

public String GeneralTruckShipments_LargeItemLocator(){
	
	String GeneralTruckShipments_LargeItemLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[4]/div";
	return GeneralTruckShipments_LargeItemLocator;
}

public String Pallets_LargeItemLocator(){
	
	String Pallets_LargeItemLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[5]";
	return Pallets_LargeItemLocator;
}

public String Machinery_LargeItemLocator(){
	
	String Machinery_LargeItemLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[6]";
	return Machinery_LargeItemLocator;
}

public String Vehicles_LargeItemLocator(){
	
	String Vehicles_LargeItemLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[7]";
	return Vehicles_LargeItemLocator;
}

public String Container_LargeItemLocator(){
	
	String Container_LargeItemLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[8]";
	return Container_LargeItemLocator;
}

public String FullTruckLoad_LargeItemLocator(){
	
	String FullTruckLoad_LargeItemLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[9]";
	return FullTruckLoad_LargeItemLocator;
}
public String FirstSubshipmentHeadingtextLocator(){
	
	String FirstSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[1]/div/h4";
	return FirstSubshipmentHeadingtextLocator;
}

public String SecondSubshipmentHeadingtextLocator(){
	
	String SecondSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[2]/div/h4";
	return SecondSubshipmentHeadingtextLocator;
}

public String ThirdSubshipmentHeadingtextLocator(){
	
	String ThirdSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[3]/div/h4";
	return ThirdSubshipmentHeadingtextLocator;
}

public String FourthSubshipmentHeadingtextLocator(){
	
	String FourthSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[4]/div/h4";
	return FourthSubshipmentHeadingtextLocator;
}

public String FifthSubshipmentHeadingtextLocator(){
	
	String FifthSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[5]/div/h4";
	return FifthSubshipmentHeadingtextLocator;
}

public String SixthSubshipmentHeadingtextLocator(){
	
	String SixthSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[6]/div/h4";
	return SixthSubshipmentHeadingtextLocator;
}

public String SeventhSubshipmentHeadingtextLocator(){
	
	String SeventhSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[7]/div/h4";
	return SeventhSubshipmentHeadingtextLocator;
}

public String EightSubshipmentHeadingtextLocator(){
	
	String EightSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[8]/div/h4";
	return EightSubshipmentHeadingtextLocator;
}
public String NinethSubshipmentHeadingtextLocator(){
	
	String NinethSubshipmentHeadingtextLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[9]/div/h4";
	return NinethSubshipmentHeadingtextLocator;
}

public String FirstSubshipmentMsgVerifyLocator(){
	
	String FirstSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[1]/div/p";
	return FirstSubshipmentMsgVerifyLocator;
}

public String SecondSubshipmentMsgVerifyLocator(){
	
	String SecondSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[2]/div/p";
	return SecondSubshipmentMsgVerifyLocator;
}

public String ThirdSubshipmentMsgVerifyLocator(){
	
	String ThirdSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[3]/div/p";
	return ThirdSubshipmentMsgVerifyLocator;
}

public String FourthSubshipmentMsgVerifyLocator(){
	
	String FourthSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[4]/div/p";
	return FourthSubshipmentMsgVerifyLocator;
}

public String FifthSubshipmentMsgVerifyLocator(){
	
	String FifthSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[5]/div/p";
	return FifthSubshipmentMsgVerifyLocator;
}

public String SixthSubshipmentMsgVerifyLocator(){
	
	String SixthSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[6]/div/p";
	return SixthSubshipmentMsgVerifyLocator;
}

public String SeventhSubshipmentMsgVerifyLocator(){
	
	String SeventhSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[7]/div/p";
	return SeventhSubshipmentMsgVerifyLocator;
}

public String EightSubshipmentMsgVerifyLocator(){
	
	String EightSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[8]/div/p";
	return EightSubshipmentMsgVerifyLocator;
}

public String NinethSubshipmentMsgVerifyLocator(){
	
	String NinethSubshipmentMsgVerifyLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div/div[9]/div/p";
	return NinethSubshipmentMsgVerifyLocator;
}

public String DocumentQuantitytextfieldLocator(){

	String DocumentQuantitytextfieldLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[3]/input";
	return DocumentQuantitytextfieldLocator;
}

public String LaptopsQuantitytextfieldLocator(){
	
	String LaptopsQuantitytextfieldLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[4]/input";
	return LaptopsQuantitytextfieldLocator;
}

public String SmallBoxQuantitytextfieldLocator(){
	
	String SmallBoxQuantitytextfieldLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[5]/input";
	return SmallBoxQuantitytextfieldLocator;
}

public String FlowersQuantitytextfieldLocator(){
	
	String FlowersQuantitytextfieldLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[6]/input";
	return FlowersQuantitytextfieldLocator;
}

public String LargeBoxQuantitytextfieldLocator(){
	
	String LargeBoxQuantitytextfieldLocator = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[7]/input";
	return LargeBoxQuantitytextfieldLocator;
}

public String QuantityDocumentAddbtnLocator(){
	
	String QuantityAddbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[3]/button[2]";
	return QuantityAddbtn;
}

public String QuantityLaptopsAddbtnLocator(){
	
	String QuantityAddbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[4]/button[2]";
	return QuantityAddbtn;
}

public String QuantitySmallBoxAddbtnLocator(){
	
	String QuantityAddbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[5]/button[2]";
	return QuantityAddbtn;
}

public String QuantityFlowersAddbtnLocator(){
	
	String QuantityAddbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[6]/button[2]";
	return QuantityAddbtn;
}

public String QuantityLargeBoxAddbtnLocator(){
	
	String QuantityAddbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[7]/button[2]";
	return QuantityAddbtn;
}

public String QuantityDocumentMinusbtnLocator(){
	
	String QuantityMinusbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[3]/button[1]";
	return QuantityMinusbtn;
}

public String QuantityLaptopsMinusbtnLocator(){
	
	String QuantityMinusbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[4]/button[1]";
	return QuantityMinusbtn;
}

public String QuantitySmallBoxMinusbtnLocator(){
	
	String QuantityMinusbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[5]/button[1]";
	return QuantityMinusbtn;
}

public String QuantityFlowersMinusbtnLocator(){
	
	String QuantityMinusbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[6]/button[1]";
	return QuantityMinusbtn;
}

public String QuantityLargeBoxMinusbtnLocator(){
	
	String QuantityMinusbtn = ".//*[@id='quoteForm']/div[1]/div/div[2]/div/div[7]/button[1]";
	return QuantityMinusbtn;
}

public String LabelPickupanddropoffAddresses(){
	
	String PickupanddropoffAddress = ".//*[@id='quoteForm']/div[1]/div/div[3]/div[1]";
	return PickupanddropoffAddress;
}

public String PickupaddresstextfieldLocator(){
	
	String PickupaddresstextfieldLocator = ".//*[@id='quoteForm']/div[1]/div/div[3]/div[2]/div[1]/div/input[2]";
	return PickupaddresstextfieldLocator;
}

public String DropoffAddresstextfieldLocator(){
	
	String DropoffAddresstextfield = ".//*[@id='quoteForm']/div[1]/div/div[3]/div[2]/div[2]/div/input[2]";
