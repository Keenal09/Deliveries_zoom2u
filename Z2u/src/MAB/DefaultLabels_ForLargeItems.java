...
public class DefaultLabels_ForLargeItems extends MAB_Scenarios {
	WebElement element;
	...
	public void LargeItem_DefaultLabels(String Shipment){
		
		System.out.println(".................................................................................................");
  		System.out.println("MAB9:Labels verification  method started for" + " " + Shipment);
		...
		if(Shipment.equals("General Van") || Shipment.equals("Furniture")){
			...
			String LabelPickup = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[4]/div/div[1]")).getText();
		    System.out.println("Pickup label is =" + LabelPickup);
		    Assert.assertEquals(LabelPickup, "Pickup details");
		    
		    String LabelDrop = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div/div[1]")).getText();
		    System.out.println("Dropoff label is =" + LabelDrop);
		    Assert.assertEquals(LabelDrop, "Dropoff details");
		    
		    String LabelDescription = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div[1]/div/label")).getText();
		    System.out.println("Dropoff label is =" + LabelDescription);
		    Assert.assertEquals(LabelDescription, "Description");
		    
		    String LabelImages = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div[3]/div/label")).getText();
		    System.out.println("label images is =" + LabelImages);
		    Assert.assertEquals(LabelImages, "Image of Freight (.png, .jpg or .pdf)");
		    
		    String LabelParcelPickup = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[7]/div[1]")).getText();
		    System.out.println("label Parcel  is =" + LabelParcelPickup);
		    Assert.assertEquals(LabelParcelPickup, "Parcel available after");
		    
		    String LabelParcelPickupDate = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[7]/div[2]/div[1]/label")).getText();
		    System.out.println("label Parcel Date  is =" + LabelParcelPickupDate);
		    Assert.assertEquals(LabelParcelPickupDate, "Date");
		    
		    String LabelParcelPickupTime = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[7]/div[2]/div[2]/label")).getText();
		    System.out.println("label Parcel Time  is =" + LabelParcelPickupTime);
		    Assert.assertEquals(LabelParcelPickupTime, "Time");
		    
		    String LabelParcelDrop = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[8]/div[1]")).getText();
		    System.out.println("label Parcel Drop  is =" + LabelParcelDrop);
		    Assert.assertEquals(LabelParcelDrop, "Required before");
		    
		    String LabelParcelDropDate = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[8]/div[2]/div[1]/label")).getText();
		    System.out.println("label Parcel Date  is =" + LabelParcelDropDate);
		    Assert.assertEquals(LabelParcelDropDate, "Date");
		    
		    String LabelParcelDropTime = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[8]/div[2]/div[2]/label")).getText();
		    System.out.println("label Parcel Time  is =" + LabelParcelPickupTime);
		    Assert.assertEquals(LabelParcelDropTime, "Time");
				   ...
				   element = Driverwaitclass.Driverwait().until(ExpectedConditions.elementToBeClickable(By.xpath(objMAB.MAB_SubLargeItem_BuildingMaterialsShipmentLocator())));
				      ...
				      String LabelPurchaseOrderNumber = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[4]/div/div/div[1]")).getText();
					  ...
					  String LabelQuantity = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[1]/label")).getText();
					  System.out.println("label quantity  is =" + LabelQuantity);
					  Assert.assertEquals(LabelQuantity, "Quantity*"); 
					  
					  String LabelLength = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[2]/label")).getText();
					  System.out.println("label length  is =" + LabelLength);
					  Assert.assertEquals(LabelLength, "Length*"); 
					  
					  String LabelWidth = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[3]/label")).getText();
					  System.out.println("label width  is =" + LabelWidth);
					  Assert.assertEquals(LabelWidth, "Width*"); 
					  
					  String LabelHeight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[4]/label")).getText();
					  System.out.println("label Height  is =" + LabelHeight);
					  Assert.assertEquals(LabelHeight, "Height*"); 
					  
					  String LabelItemWeight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[5]/label")).getText();
					  System.out.println("label Item weight  is =" + LabelItemWeight);
					  Assert.assertEquals(LabelItemWeight, "Item Weight*"); 
					  
					  String LabelTotalWeight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[6]/label")).getText();
					  System.out.println("label Total weight  is =" + LabelTotalWeight);
					  Assert.assertEquals(LabelTotalWeight, "Total Weight*");
					  
					  String LabelAddItem = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[3]/div/a")).getText();
					  System.out.println("label Add Item is =" + LabelAddItem);
					  Assert.assertEquals(LabelAddItem, "+ Add Item");
					  
					  String LabelFreightTitle = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[1]/label")).getText();
					  System.out.println("label Freight Title is =" + LabelFreightTitle);
					  Assert.assertEquals(LabelFreightTitle, "Freight Title* :");
					  
					  String LabelFreightValue = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[2]/label")).getText();
					  ...
					  String LabelDescribeShipment = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[7]/div[1]/label")).getText();
					  ...
					  String LabelDeliveryInstruction = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[7]/div[2]/label")).getText();
					  ...
					  String LabelImageFreight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[9]/div/label")).getText();
					  ...
					  String LabelPickup = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[1]")).getText();
					  System.out.println("label Pickup is =" + LabelPickup);
					  Assert.assertEquals(LabelPickup, "Pick-up location*");
					  
					  String LabelDrop = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[1]")).getText();
					  System.out.println("label Dropoff is =" + LabelDrop);
					  Assert.assertEquals(LabelDrop, "Drop-off location*");
					  
					  String LabelPickLoadingFacilities = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/span")).getText();
					  ...
					  String LabelPickLoadingFacoption = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[2]/label")).getText();
					  ...
					  String LabelPickLoadingFac2option = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[3]/label")).getText();
					  ...
					  String LabelPickLoadingFac3option = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[4]/label")).getText();
					  ...
					  String LabelDropLoadingFacilities = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/span")).getText();
					  ...
					  String LabelDropLoadingFacoption = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[2]/label")).getText();
					  ...
					  String LabelDropLoadingFac2option = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[3]/label")).getText();
					  ...
					  String LabelDropLoadingFac3option = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[4]/label")).getText();
					  ...
					  String Labelpicknotes = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[5]/div/span")).getText();
					  System.out.println("label pickup notes is =" + Labelpicknotes);
					  Assert.assertEquals(Labelpicknotes, "Notes/Other :");
					  
					  String LabelDropnotes = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[5]/div/span")).getText();
					  ...
					  String LabelPickupDate = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[7]/div[1]")).getText();
					  ...
					  String LabelDropoffDate = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[7]/div[1]")).getText();
					  ...
					  String PickYesFlexible = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[7]/div[2]/div/label[2]")).getText();
					  System.out.println("Pick yes flexible" + PickYesFlexible);
					  Assert.assertEquals(PickYesFlexible, "Yes");
					  
					  String PickNoFlexible = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[1]/div[7]/div[7]/div[2]/div/label[1]")).getText();
					  System.out.println("Pick no flexible" + PickNoFlexible);
					  Assert.assertEquals(PickNoFlexible, "No");
					  
					  String DropYesFlexible = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[7]/div[2]/div/label[2]")).getText();
					  System.out.println("Drop yes flexible" + DropYesFlexible);
					  Assert.assertEquals(DropYesFlexible, "Yes");
					  
					  String DropNoFlexible = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div/div[3]/div[7]/div[7]/div[2]/div/label[1]")).getText();
        	 ...
        	 String LabelPurchaseOrderNumber = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[4]/div/div/div[1]")).getText();
			  ...
			  String ContainerSizelabel = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[1]/label")).getText();
			  System.out.println("Container Size is" + ContainerSizelabel);
			  Assert.assertEquals(ContainerSizelabel, "Container Size*");
			  
			  String LabelQuantity = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[2]/label")).getText();
			  System.out.println("label quantity  is =" + LabelQuantity);
			  Assert.assertEquals(LabelQuantity, "Quantity*"); 
			  
			  String LabelLength = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[3]/label")).getText();
			  System.out.println("label length  is =" + LabelLength);
			  Assert.assertEquals(LabelLength, "Length*"); 
			  
			  String LabelWidth = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[4]/label")).getText();
			  System.out.println("label width  is =" + LabelWidth);
			  Assert.assertEquals(LabelWidth, "Width*"); 
			  
			  String LabelHeight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[5]/label")).getText();
			  System.out.println("label Height  is =" + LabelHeight);
			  Assert.assertEquals(LabelHeight, "Height*"); 
			  
			  String LabelItemWeight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[6]/label")).getText();
			  System.out.println("label Item weight  is =" + LabelItemWeight);
			  Assert.assertEquals(LabelItemWeight, "Item Weight*"); 
			  
			  String LabelTotalWeight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[1]/div[7]/label")).getText();
			  System.out.println("label Total weight  is =" + LabelTotalWeight);
			  Assert.assertEquals(LabelTotalWeight, "Total Weight*");
			  ...
			  String LabelContainerrent = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[3]/label")).getText();
			  ...
			  String LabelContainermsg = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[3]/p")).getText();
			  ...
			  String Containerradiobtn = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[3]/div/span")).getText();
			  ...
			  JavascriptExecutor js = ((JavascriptExecutor) driver);
			  js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			  driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[7]/div[1]/textarea")).sendKeys(Keys.TAB);
			                                                                        
			  driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[3]/div/label")).click();
			  
			  element= Driverwaitclass.Driverwait().until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[5]/div[3]/div/label")));
			  ...
			  String LabelImageFreight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[9]/div[1]/label")).getText();
			  System.out.println("label Image freight is =" + LabelImageFreight);
			  Assert.assertEquals(LabelImageFreight, "Image of Freight (.png, .jpg or .pdf)");
			  
			  String LabelSecuritynumber = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div[9]/div[2]/label")).getText();
             ...
             Assert.assertEquals(LabelPurchaseordernumber, "Purchase order number");
              ...
              String LabelPickup = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[5]/div/div[1]")).getText();
			  System.out.println("label Pickup is =" + LabelPickup);
			  Assert.assertEquals(LabelPickup, "Pickup details");
			  
			  String LabelDrop = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[6]/div/div[1]")).getText();
			  System.out.println("label Dropoff is =" + LabelDrop);
			  Assert.assertEquals(LabelDrop, "Dropoff details");
			  
			  String LabelDescription = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[7]/div[1]/div/label")).getText();
			  System.out.println("Dropoff label is =" + LabelDescription);
			  Assert.assertEquals(LabelDescription, "Description");
			  
			  String LabelImageFreight = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[7]/div[3]/div/label")).getText();
			  System.out.println("Dropoff label images is =" + LabelImageFreight);
			  Assert.assertEquals(LabelImageFreight, "Image of Freight (.png, .jpg or .pdf)");
			    
			  String Labelparcelpickup = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[8]/div[1]")).getText();
			  System.out.println("Parcel pickup label  is =" + Labelparcelpickup);
			  Assert.assertEquals(Labelparcelpickup, "Parcel available after");
			  
			  String Labelparcelpickupdate = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[8]/div[2]/div[1]/label")).getText();
			  System.out.println("Parcel pickup date is =" + Labelparcelpickupdate);
			  Assert.assertEquals(Labelparcelpickupdate, "Date");
			  
			  String Labelparceldrop = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[9]/div[1]")).getText();
			  System.out.println("Parcel drop is =" + Labelparceldrop);
			  Assert.assertEquals(Labelparceldrop, "Required before");
			  
			  String Labelparceldropdate = driver.findElement(By.xpath(".//*[@id='bookingForm']/div[1]/div/div[9]/div[2]/div[1]/label")).getText();
			  System.out.println("Parcel drop is =" + Labelparceldropdate);
			  Assert.assertEquals(Labelparceldropdate, "Date");
         }

		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("$(\"#shipment-div-active\").animate({ scrollTop: \""+100+"px\" })");
		
		 System.out.println("MAB9:Labels and Placeholder verification method completed" + " " + Shipment);
	  	    System.out.println(".................................................................................................");
